...
2. **Lee el contexto del proyecto:** `README.md`
3. **Lee el stack y arquitectura por capa:** `.github/instructions/backend.instructions.md` y `.github/instructions/frontend.instructions.md`
